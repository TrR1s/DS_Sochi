...
def sim_and_save(start_date:datetime,
                  end_date:datetime,
                  plr_pool =DefaultPoolCorr.plr_pool, 
                  trend_func =  TrendFunc.none_func,
                  lottery_scheldure =None,
                  casino_fig_file_name_csv = 'casino_fig.csv', 
                  plr_pool_file_name = "plr_pool"
                  ):
    
    
    casino_fig,plr_pool = simulator_period(start_date,
                                           end_date,
                                           plr_pool,
                                           trend_func,
                                           lottery_scheldure
                                           )
    save_sim_resuls(casino_fig,plr_pool,casino_fig_file_name_csv,plr_pool_file_name)